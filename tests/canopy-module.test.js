...
async function main() {
  ...
  assert.ok(Number(summerEvening.atmosphere['--canopy-ambient-highlight-opacity']) > 0)
  ...
  assert.equal(winterMidnight.atmosphere['--canopy-direct-opacity'], undefined)
  assert.equal(winterMidnight.atmosphere['--canopy-beam-opacity'], undefined)
  assert.equal(winterMidnight.atmosphere['--canopy-horizon-opacity'], undefined)
